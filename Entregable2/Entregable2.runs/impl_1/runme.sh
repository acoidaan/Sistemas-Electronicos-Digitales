...
HD_PWD='C:/ULL/Sistemas-Electronicos-Digitales/Entregable2/Entregable2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sistema119.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sistema119.tcl -notrace
