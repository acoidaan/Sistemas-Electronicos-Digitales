...
HD_PWD='C:/ULL/Sistemas-Electronicos-Digitales/Entregable2/Entregable2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sistema119.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sistema119.tcl
