...
HD_PWD='C:/ULL/SED/Actividad4/Actividad4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dec7seg_estructural.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dec7seg_estructural.tcl
