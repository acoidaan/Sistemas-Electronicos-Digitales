...
HD_PWD='C:/ULL/SED/Actividad4/Actividad4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dec7seg_estructural.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dec7seg_estructural.tcl -notrace
