...
HD_PWD='D:/ULL/SED/Actividad 3/Actividad 3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log funciones.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source funciones.tcl
