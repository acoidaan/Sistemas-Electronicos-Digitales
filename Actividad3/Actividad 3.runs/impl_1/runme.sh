...
HD_PWD='D:/ULL/SED/Actividad 3/Actividad 3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log funciones.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source funciones.tcl -notrace
